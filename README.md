...
### AI/LLM
- **Claude 4.5 Sonnet** — одна из моделей (Anthropic)
- **Qwen 2.5 72B** — альтернатива через OpenRouter
- **DeepSeek** — альтернатива через OpenRouter
- **Ollama** — локальные модели (офлайн-режим, любые)
...
git clone https://github.com/Eazyan/MPIT_Habar.git
cd MPIT_Habar
...
Разработано для хакатона "Моя профейссия — ИТ (МПИТ)" 2025.
